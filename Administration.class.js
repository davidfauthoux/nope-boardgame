...
class Administration {
	constructor(rootLayout, layout, game) {
		...
		*/
		...
		UserInteraction.get().click(this._adminLayout.add().$.addClass("iconButton").addClass("fitButton"), function() {
		...
		UserInteraction.get().click(this._adminLayout.add().$.addClass("iconButton").addClass("newButton"), function() {
			window.location = Administration.rootUrl() + "/" + Administration.platformId() + "@" + Administration.gameId() + "@" + Server.uuid();
		});
		UserInteraction.get().click(this._adminLayout.add().$.addClass("iconButton").addClass("logButton"), function() {
	...
	button(className, callback) {
		UserInteraction.get().click(this.layout.add().$.addClass("iconButton").addClass(className + "Button"), callback);
	}
}

Administration.storeKey = function(key) {
	return Administration.platformId() + "@" + Administration.gameId() + "/" + key;
};
