...
FaceIcon.isNobody = function(face) {
	if (face.startsWith("nobody:")) {
		return FaceIcon._nobodies[parseInt(face.substring("nobody:".length)) % FaceIcon._nobodies.length];
	} else {
		return undefined;
	}
};
